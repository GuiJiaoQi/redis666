...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#importActivityBtn").click(function () {
			/*alert("ok");*/
			//收集参数  必须上传Excel 看后缀名.xls
			var activityFileName = $("#activityFile").val();
			/*alert(activityFileName);*/
			//lastIndexOf(".")  取最后一个点在哪  后缀
			var suffix = activityFileName.substr(activityFileName.lastIndexOf(".")+1).toUpperCase();//全部转为大写
			/*alert(suffix);*/
			if (suffix!='XLS'){
		...
		$.ajax({
			...
			/*	var htmlStr="";
				$.each(data.activityList,function (index,obj) {
					...
					htmlStr+="<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/activity/detail.do?id='+id;\">"+obj.name+"</a></td>";
